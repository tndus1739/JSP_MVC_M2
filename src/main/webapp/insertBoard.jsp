...
<body>
	...
	<form method = "post" action = "insertBoard.do"> <!-- do 요청은 Board_Controller.java에서 받도록 설정   -->
		<table border = "1"  cellpadding ="10" cellspacing = "0">   <!-- cellpadding : cell과 cell 사이의 간격  -->
			<tr> <td bgcolor ="pink" > 제목 </td> 
				 <td> <input type ="text" name = "title"> </td> 
		    </tr>
			<tr> <td bgcolor ="pink"> 작성자 </td> 
				 <td> <input type ="text" name = "write" size ="10"></td> 
		    </tr>
			<tr> <td bgcolor ="pink"> 내용 </td> 
